...
AI Pixel Office supports loading furniture assets from directories outside the extension. This lets you use custom or third-party pixel art asset packs alongside the built-in furniture.

## Adding an External Directory

1. Open the AI Pixel Office panel and click **Settings**
...
4. The directory path is saved to `~/.ai-pixel-office/config.json` and reloaded automatically on restart
